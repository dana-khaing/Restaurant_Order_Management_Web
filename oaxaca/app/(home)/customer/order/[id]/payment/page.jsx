    ...
    async function payForOrder(orderId) {
        ...
        if (!response.ok) {
            ...
            toast({
                ...
                description:
                    "Payment failed, please make sure your payment information is correct.",
            });
            return;
        }
        ...
        <Card className="w-full ">
            <CardHeader className="bg-white pb-4">
                <div className="space-y-1.5">
                    <CardTitle className="text-2xl text-orange-500 font-bold">
                        Order Payment for Oaxaca
                    </CardTitle>
                    <CardDescription>
            ...
            <CardFooter className="bg-white space-y-4 pt-4">
                ...
                <Button
                    ...
                    size="lg"
                    variant="outline"
                    onClick={() => router.push(`/customer/order/${params.id}`)}
                >
                    Cancel
                </Button>
            </CardFooter>
